...
export default async function RepLoginPage() {
  ...
  // Already authenticated as rep - redirect to dashboard
  if (session?.user?.role === 'rep') {
    redirect('/rep')
  }

  // Logged in as different role (admin) - show switch account UI
        ...
        {isWrongRole ? (
          <div className="space-y-6">
            ...
            <p className="text-sm text-center text-muted-foreground">
              To access the Sales Rep Portal, please sign out first.
            </p>
