...
export interface FilterField {
  ...
  allowMultiple?: boolean; // Enable multi-select with chip/tag UI
}
...
export interface FilterState {
  ...
  value: string | string[] | number | [string, string]; // string[] for multi-select
}
...
export interface RepScorecardRow {
  ...
  revenueHistory: number[]; // Monthly revenue for past 6 months (for sparkline)
}
