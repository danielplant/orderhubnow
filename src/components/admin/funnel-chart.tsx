...
import { EmptyReportState, FunnelChartSkeleton } from './empty-report-state';
  ...
  if (stages.length === 0) {
    return (
      <EmptyReportState
        ...
        description="Track how new customers convert to repeat buyers. This funnel shows the progression from first order to subsequent purchases over 30, 60, and 90-day windows."
