      ...
      <table className="w-full text-sm border-collapse">
        <thead>
          <tr className="bg-muted/50">
            {/* Row identifier column - sticky */}
            <th className="sticky left-0 z-10 bg-muted/50 px-3 py-2 text-left font-medium border-b border-r min-w-[200px]">
              SKU
            </th>
            {rowLabelField && (
            ...
            {/* Row total column */}
            {showRowTotals && (
              <th className="px-3 py-2 text-center font-medium border-b border-l bg-muted/30 min-w-[80px]">
                Total
              </th>
            )}
          </tr>
        ...
        {showColumnTotals && (
          <tfoot>
            <tr className="bg-muted/30 font-medium">
              <td className="sticky left-0 z-10 bg-muted/30 px-3 py-2 border-t border-r">
                Total
              </td>
