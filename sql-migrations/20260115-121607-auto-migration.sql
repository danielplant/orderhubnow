...
-- Generated: Thu 15 Jan 2026 12:16:07 EST
...
IF NOT EXISTS (SELECT 1 FROM SchemaMigrations WHERE Name = '20260115-121607-auto-migration')
    INSERT INTO SchemaMigrations (Name) VALUES ('20260115-121607-auto-migration');
GO
